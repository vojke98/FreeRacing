...
export class Renderer {
    ...
    render(scene, camera, light) {
        ...
        gl.uniform3fv(program.uniforms.uLightPosition, [0,0,10]);
        ...
        //console.log(light.source.rotation);
        gl.uniform3fv(program.uniforms.uLightDirection, [.2,.5,-1]); // pointing towards the plane (good enough for the sun) light.source.getDirection()
